...
export const MobileMenuOverlay: React.FC<MobileMenuOverlayProps> = ({ isOpen, onClose, actions, hasPhone = true }) => {
    ...
    const menuItems = [
        ...
        { label: "EQUIPMENT", icon: <Shield />, action: actions.onOpenEquipment, color: "bg-orange-900/80 border-orange-700" },
        { label: "SKILLS", icon: <Zap />, action: actions.onOpenSkills, color: "bg-yellow-800/80 border-yellow-600" },
        { label: "VAULT", icon: <Archive />, action: actions.onOpenLootVault, color: "bg-amber-800/80 border-amber-600" },
        { label: "LOOT", icon: <Gem />, action: actions.onOpenLoot, color: "bg-amber-900/80 border-amber-700" },
        
        { label: "PARTY", icon: <Swords />, action: actions.onOpenParty, color: "bg-indigo-900/80 border-indigo-700" },
        { label: "SOCIAL", icon: <Users />, action: actions.onOpenSocial, color: "bg-pink-900/80 border-pink-700" },
        { label: "PHONE", icon: <Smartphone />, action: actions.onOpenPhone, color: "bg-blue-900/80 border-blue-700", disabled: !hasPhone },
        { label: "SHELTER", icon: <Flag />, action: actions.onOpenFamilia, color: "bg-blue-800/80 border-blue-600" },

        { label: "TASKS", icon: <ClipboardList />, action: actions.onOpenTasks, color: "bg-purple-900/80 border-purple-700" },
        { label: "SAVES", icon: <HardDrive />, action: actions.onOpenSaveManager, color: "bg-slate-900/80 border-slate-700" },
        { label: "STORY", icon: <BookOpen />, action: actions.onOpenStory, color: "bg-green-900/80 border-green-700" },
        { label: "CONTRACT", icon: <Scroll />, action: actions.onOpenContract, color: "bg-red-900/80 border-red-700" },
        // Removed Map

        { label: "NEARBY", icon: <Radar />, action: actions.onOpenPresent, color: "bg-zinc-800 border-zinc-600" },
        { label: "WORLD", icon: <Globe />, action: actions.onOpenWorld, color: "bg-cyan-900/80 border-cyan-700" },
        { label: "MEMORY", icon: <Brain />, action: actions.onOpenMemory, color: "bg-fuchsia-900/80 border-fuchsia-700" },
        { label: "SYSTEM", icon: <Settings />, action: actions.onOpenSettings, color: "bg-black border-2 border-white" },
    ];
